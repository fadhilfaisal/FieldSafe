...
import { InspectorNotificationProvider } from '../../notifications/InspectorNotificationProvider'
...
import { InspectorNotificationCenter } from '../feedback/InspectorNotificationCenter'
import { InspectorSyncFeedback } from '../feedback/InspectorSyncFeedback'
import { ToastProvider } from '../feedback/ToastProvider'
import { BrandMark } from './BrandMark'
import { FieldInspectionContextHostContext } from './fieldInspectionContextHost'
  ...
  return (
    <ToastProvider>
      <ConnectivityProvider>
        <InspectorNotificationProvider userId={user?.id}>
          <FieldShellContent />
        </InspectorNotificationProvider>
      </ConnectivityProvider>
    </ToastProvider>
  )
}
...
function FieldShellContent() {
  ...
  const [inspectionContextHost, setInspectionContextHost] =
  ...
  return (
    <FieldInspectionContextHostContext.Provider value={inspectionContextHost}>
      <div className="min-h-dvh bg-slate-100 sm:p-4 lg:p-6">
        <InspectorSyncFeedback />
        <div className="shell-surface mx-auto flex h-dvh max-w-5xl flex-col overflow-hidden sm:h-[calc(100dvh-2rem)] sm:rounded-2xl lg:h-[calc(100dvh-3rem)]">
          ...
          <div
            ref={setInspectionContextHost}
            className="shrink-0"
            data-testid="inspector-context-host"
          />
    ...
    </FieldInspectionContextHostContext.Provider>
  )
}
